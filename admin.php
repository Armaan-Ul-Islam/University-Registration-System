...
if($studentid==''||$finee==''||$fee==''){echo"please Fill All the Fields ";}
					  ...
					  $sql="INSERT INTO hall (studentid,finee,fee,hallname)
VALUES ('$studentid', '$finee','$fee','$hallname')";
...
<table cellspacing="0">
    <tr> <th><h1 style='font-size:18px' > Student_ID </h1> </th><th> <h1 style='font-size:18px' > Hall </h1></th><th> <h1 style='font-size:18px' > Fine </h1></th><th><h1 style='font-size:18px' > Fee </h1></th>  <th><h1 style='font-size:18px' > Operation </h1></th> <th><h1 style='font-size:18px' > Operation</h1></th></tr> 
...
while($row = mysqli_fetch_array($result)) {
    ...
    <tr>   <td><?php echo $s=$row['studentid'];  ?></td><td><?php echo $row['hallname'];  ?></td><td> <?php echo $row['finee']; ?></td><td> <?php echo $total=$row['fee'] ?> </td> <td> <a href='edit.php?edit=1&studentid=<?php echo $s; ?>'>EDIT </a></td>   <td> <a href='del.php?studentid=<?php echo $s; ?>'>Delete</a></td> </tr>
