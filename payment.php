...
<h3 style='color:red;font-size:25px'><b> Make Payment to +8801674092684 </b></h3> 
...
<img src='http://bluecart.com.bd/media/wysiwyg/bkash-send-money.jpg' alt='nOT found'>
...
<input style="display:none;width:200px;border-radius: 4px;" name="tc" type="text" value="<?php echo $_GET['tc']; ?>">
<input style="display:none;width:200px;border-radius: 4px;" name="studentid" type="text" value="<?php echo $studentid; ?>">
<input style="display:none;width:200px;border-radius: 4px;" name="total" type="text" value="<?php echo $_GET['total']; ?> ">
...
<br><br><h3 style='color:red;font-size:25px'><b> OR </b></h3> <br><br>

<img height="100" src="http://banglaspy.com/images/sonali%20bank.gif">
<br>

<form action='paycheck2.php' method='post' >
<input style="width:200px;border-radius: 4px;" name="tnx" type="text" placeholder="Transection ID (TrxID) ">
<input style="display:none;width:200px;border-radius: 4px;" name="tc" type="text" value="<?php echo $_GET['tc']; ?>">
<input style="display:none;width:200px;border-radius: 4px;" name="studentid" type="text" value="<?php echo $studentid; ?>">
<input style="display:none;width:200px;border-radius: 4px;" name="total" type="text" value="<?php echo $_GET['total']; ?> ">
<input type="submit" style="color: white;width:200px;height:30px; background-color: #7845BA; border-radius: 4px;"  value="Bank Diposit">
